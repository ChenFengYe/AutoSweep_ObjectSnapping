...
public class EditorObjExporter : ScriptableObject
{
        ...
        using (StreamWriter sw = new StreamWriter(folder + Path.DirectorySeparatorChar + filename + ".mtl"))
        {
            foreach (KeyValuePair<string, ObjMaterial> kvp in materialList)
            {
                ...
                if (kvp.Value.textureName != null)
                {
                    ...
                    destinationFile = targetFolder +'/' + Path.GetFileName(destinationFile);
                    relativeFile = "./" + Path.GetFileName(destinationFile);
    ...
    public static void ExportWholeSelectionToSingle()
    {
        ...
        if (exportedObjects > 0)
        {
            ...
            string filename = selection[0].gameObject.name.Substring(0, selection[0].gameObject.name.Length-7);
    ...
    public static void ExportEachSelectionToSingle()
    {
        ...
        if (exportedObjects > 0)
        {
            Debug.Log("Objects exported: " + "Exported " + exportedObjects + " objects");
